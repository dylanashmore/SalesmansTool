...
export default function ZipScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#1C1C1E" }}>
      ...
      {/* Sheet */}
      <View style={{ flex: 1, backgroundColor: "#FFF", borderTopLeftRadius: 26, borderTopRightRadius: 26, overflow: "hidden" }}>
        <ScrollView
          showsVerticalScrollIndicator={false}
          keyboardShouldPersistTaps="handled"
          contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 26, paddingTop: 34, paddingBottom: 44 }}
        >
